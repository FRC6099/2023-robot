...
import frc.robot.commands.autonomous.DropAndBackupCommandSequence;
...
public class RobotContainer {
  ...
  private void configureAutonomousModes() {
    ...
    this.autonomousChooser.addOption("Drop and Reverse", new DropAndBackupCommandSequence(arm, claw, driveTrain));
